...
function entrada(){
    var placa = document.getElementById('placa-do-carro').value; // captura o valor dentro do elemento selecionado pelo id.
    var placa = placa.toUpperCase();                            //converte as letras digitas para maiusculas
